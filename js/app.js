(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".soon__slider")) new core(".soon__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                loop: true,
                navigation: {
                    prevEl: ".soon-arrow_prev",
                    nextEl: ".soon-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".info__slider")) new core(".info__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".slike-ware__slider")) {
                new core(".slike-ware__slider", {
                    ...
                    thumbs: {
                        swiper: {
                            el: ".thumbs-ware__slider",
                            slidesPerView: 3,
                            direction: "vertical"
                        }
                    },
                    navigation: {
                        prevEl: ".slike-arrow_prev",
                        nextEl: ".slike-arrow_next"
                    },
                    on: {}
                });
                new core(".thumbs-ware__slider", {
                    modules: [ Navigation, Thumb ],
                    direction: "vertical",
                    slidesPerView: 3,
                    spaceBetween: 25,
                    navigation: {
                        prevEl: ".thumbs-arrow_prev",
                        nextEl: ".thumbs-arrow_next"
                    },
                    on: {}
                });
            }
